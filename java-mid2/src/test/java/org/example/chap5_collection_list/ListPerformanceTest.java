...
class ListPerformanceTest {
    ...
    private long addFirst(final List<Integer> list) {
    ...
    private long addMid(final List<Integer> list) {
        long start = System.currentTimeMillis();
        for (int i = 0; i < size; i++) {
            list.add(i / 2, i);
        }
    ...
    private long addLast(final List<Integer> list) {
        long start = System.currentTimeMillis();
        for (int i = 0; i < size; i++) {
            list.add(i);
        }
    ...
    private void getIndex(final List<Integer> list, final int loop, final int index) {
        long start = System.currentTimeMillis();
    ...
    private void search(final List<Integer> list, final int loop, final int findValue) {
        long start = System.currentTimeMillis();
        for (int i = 0; i < loop; i++) {
